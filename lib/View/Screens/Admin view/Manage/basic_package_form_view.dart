...
class BasicPackageFormView extends StatelessWidget {
  const BasicPackageFormView({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    // ignore: unused_local_variable
    BasicFormController basicFormCrl = Get.put(BasicFormController());
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: titleText,
...
//_______________________________DIVIDER
  ...
  numberOfPeopleTextField() {
    return GetBuilder<BasicFormController>(builder: (controller) {
      return Container(
          height: 45,
