...
class PremiumPackageFormView extends StatelessWidget {
  const PremiumPackageFormView({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    // ignore: unused_local_variable
    PremiumFormController basicFormCrl = Get.put(PremiumFormController());
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: titleText,
...
//_______________________________DIVIDER
  ...
  numberOfPeopleTextField() {
    return GetBuilder<PremiumFormController>(builder: (controller) {
      return Container(
          height: 45,
